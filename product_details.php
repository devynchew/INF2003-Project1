...
<body>
    ...
    function displayProductAndReviews($connection)
    {
        ...
        if (isset($_GET['id'])) {
            ...
            $productSql = "SELECT productName, productInfo, productPrice, feature1, feature2, feature3, productImg, category, quantity FROM product WHERE productID = $productID";
            ...
            if (mysqli_num_rows($productResult) > 0) {
                ...
                echo '<img src="' . $productRow['productImg'] . '" class="img-fluid product-image" alt="Product Image">';
                echo '</div>';
                echo '<div class="col-md-6 product-details">';
                // Display content
                echo '<div id="display-content">';
                echo '<h2>' . $productRow['productName'] . '</h2>';
                echo '<h3 class="price">Price: $' . $productRow['productPrice'] . '</h3>';
                echo '<p class="description">' . $productRow['productInfo'] . '</p>';
                echo '<h3>Product Details</h3>';
                echo '<ul>';
                    echo '<li>' . $productRow['feature1'] . '</li>';
                    echo '<li>' . $productRow['feature2'] . '</li>';
                    echo '<li>' . $productRow['feature3'] . '</li>';
                echo '</ul>';
